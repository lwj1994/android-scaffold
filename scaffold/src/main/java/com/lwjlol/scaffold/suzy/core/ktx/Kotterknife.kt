...
import com.lwjlol.scaffold.core.ktx.BaseHolder
import java.util.*
...
fun <V : View> BaseHolder.bindItemView(id: Int)
    : ReadOnlyProperty<BaseHolder, V> = required(
    id, viewFinder)
...
private val BaseHolder.viewFinder: BaseHolder.(Int) -> View?
